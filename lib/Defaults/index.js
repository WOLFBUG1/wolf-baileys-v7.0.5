...
exports.version = [2, 3000, 2023190939];
...
exports.DEFAULT_CONNECTION_CONFIG = {
    ...
    wsHighWaterMark: 4 * 1024 * 1024,
    wsLowWaterMark: 1024 * 1024,
    wsBackpressureTimeoutMs: 15E3,
    ...
    operationSchedulerOptions: {
        ...
        maxQueueSize: 1000,
        queueTimeoutMs: 30E3,
        adaptiveIntervalMs: 2E3,
        adjustmentCooldownMs: 4E3,
        slowOperationMs: 2500,
        slowQueryMs: 5E3,
