...
exports.RECONNECTABLE_STATUS_CODES = new Set([
    ...
    exports.DisconnectStatusCode.rateLimited,
    exports.DisconnectStatusCode.badGateway,
    exports.DisconnectStatusCode.unavailableService,
    exports.DisconnectStatusCode.gatewayTimeout
]);
...
const getReconnectDecision = (input, options = {}) => {
    ...
    if (statusCode === exports.DisconnectStatusCode.connectionReplaced) {
        return {
            reconnect: false,
            fatal: false,
            resetSession: false,
            statusCode,
            delayMs: 0,
            reason: 'connection replaced; suppress automatic reconnect oscillation'
        };
    }
    ...
    if (statusCode === undefined || exports.RECONNECTABLE_STATUS_CODES.has(statusCode)) {
        const pressureFloorMs = statusCode === exports.DisconnectStatusCode.rateLimited ? 30000 :
            [exports.DisconnectStatusCode.forbidden, exports.DisconnectStatusCode.badGateway, exports.DisconnectStatusCode.unavailableService, exports.DisconnectStatusCode.gatewayTimeout].includes(statusCode) ? 10000 : 0;
        const delayMs = withJitter(Math.max(pressureFloorMs, Math.min(maxDelayMs, initialDelayMs * Math.pow(2, attempt))), randomizationFactor);
        return {
            reconnect: true,
            fatal: false,
            resetSession: false,
