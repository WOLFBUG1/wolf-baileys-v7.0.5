...
const session_operation_scheduler_1 = require("../Utils/session-operation-scheduler");
const registration_1 = require("./registration");
const username_1 = require("./username");
Object.keys(username_1).forEach((key) => {
    if (key !== "default" && !Object.prototype.hasOwnProperty.call(exports, key)) {
        Object.defineProperty(exports, key, { enumerable: true, get: () => username_1[key] });
    }
});
...
const makeWASocket = (config) => {
    const resolvedConfig = {
        ...
        ...config,
        operationSchedulerOptions: {
            ...Defaults_1.DEFAULT_CONNECTION_CONFIG.operationSchedulerOptions,
            ...(config === null || config === void 0 ? void 0 : config.operationSchedulerOptions)
        }
    };
    const scheduler = (config === null || config === void 0 ? void 0 : config.operationScheduler) || new session_operation_scheduler_1.SessionOperationScheduler({
        ...resolvedConfig.operationSchedulerOptions,
        logger: resolvedConfig.logger,
        highWaterMark: resolvedConfig.wsHighWaterMark
    });
    resolvedConfig.operationScheduler = scheduler;
    const sock = (0, registration_1.makeRegistrationSocket)(resolvedConfig);
    scheduler.setTransport(sock.ws);
    for (const methodName of ['sendMessage', 'sendMessageToUsername', 'relayMessage']) {
        if (typeof sock[methodName] !== 'function') {
            continue;
        }
        const original = sock[methodName].bind(sock);
        sock[methodName] = (...args) => scheduler.schedule('operation', () => original(...args), { label: methodName });
    }
    Object.defineProperty(sock, '__wolfOperationScheduler', {
        value: scheduler,
        configurable: true
    });
    return sock;
